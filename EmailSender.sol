...
contract EmailSender is AccessControl, ReentrancyGuard {
    ...
    function linkWallets(string[] memory emails, address[] memory wallets, address[] memory referrals) public onlyModeratorAndOwner {
    ...
    function processPayment() public nonReentrant {
    ...
    function reclaimUnclaimedTokens(string calldata email, address token) external nonReentrant onlyModeratorAndOwner {
...
// Getter
function referralByEmail(string memory email) public view onlyModeratorAndOwner returns (address) {
...
// Getter
function depositByEmailAndAddress(string memory email, address addr) public view onlyModeratorAndOwner returns (uint256) {
    return emailDeposits[email][addr];
}

// Setter
function depositByEmailAndAddress(string memory email, address addr, uint256 amount) public  onlyModeratorAndOwner {
    emailDeposits[email][addr] = amount;
}

// Getter
function tokensByEmail(string memory email) public view onlyModeratorAndOwner returns (address[] memory) {
...
// Getter
function depositTimestampByEmailAndAddress(string memory email, address addr) public view onlyModeratorAndOwner returns (uint256) {
    return emailDepositTimestamps[email][addr];
}

// Setter
function depositTimestampByEmailAndAddress(string memory email, address addr, uint256 timestamp) public onlyModeratorAndOwner {
